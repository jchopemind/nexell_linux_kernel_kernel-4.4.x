...
//since the playback path is determined in register value,we have to enable one port. 
  __REG(OUTPUT_CONTROL,			0x1019,	0x1018, b_00000100, 0, WC,B)  //class -d is selected by default. 
#ifndef _PASS1_COMPLETE_
...
#define OUT_CTRL_HP_EN					b_00000001	// If OutCTL[7]=0, 1=Enable Headphone, 0=Disable Headphone
  ...
  __REG(INPUT_CONTROL,			0x101A,	0x1019, b_00000000, 0, WI,B)
#ifndef _PASS1_COMPLETE_
...
#define STREAM4_GAIN_MASK				b_00011111	// range 0x00-0x4A (0dB to -74dB)
  ...
  __REG(MIX0_INPUT0,			0x101F, 0xffff, b_10000000, 0, WI,B)	// stream1 out
  __REG(MIX0_INPUT1,			0x1020, 0xffff, b_00000000, 0, WI,B)	// stream3 out
  __REG(MIX0_INPUT2,			0x1021, 0xffff, b_10000000, 0, WI,B)	// stream4 out
  ...
  __REG(MIX0_SOURCE0,			0x1184, 0xffff, b_00000001, 0, WI,B)	// stream1 out
  ...
  __REG(MIX1_SOURCE0,			0x1188, 0xffff, b_00000000, 0, WI,B)	// none
...
//  __REG(CLOCK_DIVIDER,			0x0F50,	0x0F50,	b_00001111, 0, WI,B)  // Port1 external clock enabled
    __REG(CLOCK_DIVIDER,			0x0F50,	0x0F50,	0x3F, 0, WI,B)  // Port1 slave, Port2 Master 2.048 MHz
#ifndef _PASS1_COMPLETE_
...
#define PORT1_DIV_SEL_EXT				b_00001111	// 0xf = external clock enabled
  ...
  __REG(PORT1_CONTROL,			0x0F51,	0x0F51,	b_10100000, 0, WI,B)
#ifndef _PASS1_COMPLETE_
...
//  added rerouting render stream to second I2S output ( 16 Kbps/ 16BITS)
  __REG(STREAM4_RATE,			0x116F,	0xffff, 0xAA,       0, WI,B) // dsp -> PCM-2 8Kbps output
  __REG(STREAM4_ROUTING,		0x1170,	0xffff,	0x0A,       0, WI,B)
  __REG(STREAM6_RATE,			0x1172,	0xffff, 0x20,       0, WI,B) // dsp -> PCM-2 8Kbps output
  ...
  __REG(STREAM6_ROUTING,		0x1182,	0xffff,	0x05,       0, WI,B)
  __REG(STREAM7_SOURCE,			0x117F, 0xffff, 0x05,       0, WI,B) // dsp -> I2S-2 (5 wire)
  __REG(STREAM8_SOURCE,                 0x1180, 0xffff, 0x06,        0, WC,B)
  __REG(STREAM8_RATE,			0x1175, 0xffff, 0x02,       0, WC,B) 
  __REG(PORT2_CONTROL,      		0x0F5E,	0x0F5E,	0XB5,        0, WI,B)  // Delay 1 bit, RX/TX en, mode =PCM , inverted.
  __REG(PORT2_CLOCK_PER_FRAME,     	0x0F5F,	0x0F5F,	0X1F,        0, WI,B)  // 256-bits per frame.
  __REG(PORT2_SYNC_WIDTH,      		0x0F60,	0x0F60,	0X00,        0, WI,B)  // Short frame sync
