...
static struct capture_size sensor_sizes_nvp6158c[] = {
	{  1920, 1080 },	/* FHD */
	{  1920, 1080 },	/* HD */
	{  1920, 1080 },	/* VGA */
	{  1920, 1080 },	/* QVGA */
...
static int sensor_nvp6158c_init(struct v4l2_subdev *subdev, u32 val)
{
  ...
  if(val == 0)
	...
	for(i=0; i<2; i++)
	{
		...
		if(i==0)
			raptor3_output_set(client, i, 1);	//vin1 -- vdo2->vdo1
		else
...
static int sensor_nvp6158c_probe(struct i2c_client *client,
...
static struct i2c_driver sensor_nvp6158c_vga_driver = {
	.driver = {
		.name	= SENSOR_NAME,
	},
...
module_i2c_driver(sensor_nvp6158c_vga_driver);

MODULE_AUTHOR("Younghee Lee <yh202.lee@samsung.com>");
MODULE_DESCRIPTION("Sensor nvp6158c_vga driver");
