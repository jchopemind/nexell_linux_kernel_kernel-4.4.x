...
static struct sensor_reg sensor_initialize_cm130pc20[] = {
  ...
  {0x21, 0x0a},//row start L 0x2a(42)
  {0x22, 0x00},//col start H
  {0x23, 0x0c},//col start L 0x0c(12)
  {0x24, 0x02},//win height H
  {0x25, 0xd0},//win height L 0x2d0(720)
  ...
  // PAGE 10
  {0x03, 0x10},
  {0x10, 0x05},//Ycbcr422_bit Order: YUYV, ITU656-like
  {0x20, 0x01},//ITU656-like SOF,EOF enable, [4]bit 0:0x8010/1:0x0000
  {0x24, 0x80},//ITU656-like SOF
  {0x25, 0x80},//ITU656-like SOL
  {0x26, 0xb6},//ITU656-like EOF
  {0x27, 0x9d},//ITU656-like EOL
...
#elif defined(CONFIG_VGA_VIDEO_TYPE_OF_CM130PC20)
static struct sensor_reg sensor_initialize_cm130pc20[] = {
  {0x01, 0xf1},//sleep on
  {0x08, 0x0f},//Hi-Z on
  {0x01, 0xf0},//sleep off
...
//  {0x13, 0x80},//Bayer windowing enable 110407
  ...
  {0x84, 0xe7}, 
  {0x85, 0x80}, 
  {0x86, 0x01}, //EXPMin 9375.00 fps
  {0x87, 0x90},
  {0x88, 0x07}, //EXP Max 8.00 fps 
  {0x89, 0x24}, 
  {0x8a, 0x20}, 
  {0x8B, 0x92}, //EXP100 
  {0x8C, 0x18}, 
  ...
  {0x9b, 0x9a},//outdoor th1
  {0x9a, 0x28},//outdoor th2
  {0x9c, 0x09}, //EXP Limit 1562.50 fps 
  {0x9d, 0x60}, 
  {0x9e, 0x01}, //EXP Unit 
  {0x9f, 0x90},
  {0xa0, 0x00},
